...
class Market(BaseComponent):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.tax_rate = 0.1 # max pay 1 token
        ...
        self.messages_step = {c : [] for c in self.commodities}
        self.chat_history = {c : [] for c in self.commodities}
        self.chat_labor = 1.0
            ...
            while any(possible_match) and keep_checking:
                ...
                while True:
                    ...
                    # TRADE! (then restart inner loop)
                        ...
                        seller.state["inventory"]["Token"] += int(payment_to_seller * (1 - self.tax_rate)) # seller paying tax
    ...
    def component_step(self):
        ...
        for resource in self.commodities:
            self.messages_step[resource] = []
            for agent in world.agents:
                # Testing!!! not multiply 0.995
                ...
                obs[agent.idx].update(
                    {
                        ...
                        "all_asks-{}".format(c): self.ask_hists[c],
                    }
                )
